...
Create placeholder text for designs, mockups, and content drafts.

Live: <https://crusher-labs.github.io/lorem-ipsum-generator/>
...
- Or serve the parent workspace via the hub's preview server: `cd ../../tools-hub && npm run preview` then visit `http://127.0.0.1:8723/utility-tools/lorem-ipsum-generator/`.
